...
public class ChatDataManager {
    ...
    public void addOrUpdateSession(String sessionId, String modelId, String prompt) {
        ...
        values.put(ChatDatabaseHelper.COLUMN_SESSION_PROMPT, prompt);
    ...
    public List<SessionItem> getAllSessions() {
        ...
        Cursor cursor = db.query(ChatDatabaseHelper.TABLE_SESSION,
                new String[]{ChatDatabaseHelper.COLUMN_SESSION_ID,
                        ...
                        ChatDatabaseHelper.COLUMN_SESSION_PROMPT},
        ...
        if (cursor != null) {
            while (cursor.moveToNext()) {
                ...
                String prompt = cursor.getString(cursor.getColumnIndex(ChatDatabaseHelper.COLUMN_SESSION_PROMPT));
                list.add(new SessionItem(sid, mid, name, prompt));
            }
            cursor.close();
        }
        db.close();

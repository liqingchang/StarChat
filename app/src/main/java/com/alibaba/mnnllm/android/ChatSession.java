...
public class ChatSession implements Serializable {
    ...
    public ChatSession(String sessionId, String configPath, boolean useTmpPath, List<ChatDataItem> history, boolean isDiffusion) {
        this(sessionId, configPath, useTmpPath, history, false, null);
    }

    public ChatSession(String sessionId, String configPath, boolean useTmpPath, List<ChatDataItem> history, String prompt) {
        this(sessionId, configPath, useTmpPath, history, false, prompt);
    }

    public ChatSession(String sessionId, String configPath, boolean useTmpPath, List<ChatDataItem> history, boolean isDiffusion, String prompt) {
    ...
    public void load() {
        ...
        nativePtr = initNative(configPath, useTmpPath, historyStringList, isDiffusion, prompt);
    }
...
//    public native long initNative(String configPath, boolean useTmpPath, List<String> history, boolean isDiffusion);
    ...
    public native long initNative(String configPath, boolean useTmpPath, List<String> history, boolean isDiffusion, String prompt);
